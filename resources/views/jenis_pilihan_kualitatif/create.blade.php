...
@section('content')
    <div class="container-fluid py-0 px-6">
        <h4 class="mb-4">Tambah Jenis Pilihan Kualitatif</h4>

        <div class="card shadow-sm bg-light">
            <div class="card-body">
                <form action="{{ route('jenis_pilihan_kualitatif.store') }}" method="POST">
                    @csrf

                    <div class="mb-3">
                        <label for="keterangan" class="form-label">Jenis Pilihan Kualitatif</label>
                        <input type="text" name="keterangan" id="keterangan" class="form-control" autofocus required>
                    </div>
